...
/**
 * Class for advanced spectrum search response network message.
 *
 * @author Murat Artim
 * @date 24 Jan 2018
 * @time 14:03:00
 */
public class AdvancedSpectrumSearchResponse extends DataMessage implements BigMessage {
	...
	/**
	 * Creates advanced spectrum search response network message.
	 */
	public AdvancedSpectrumSearchResponse() {
