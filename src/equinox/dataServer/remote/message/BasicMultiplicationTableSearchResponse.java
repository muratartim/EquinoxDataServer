...
/**
 * Class for basic multiplication table search response network message.
 *
 * @author Murat Artim
 * @date 24 Jan 2018
 * @time 14:35:18
 */
public class BasicMultiplicationTableSearchResponse extends DataMessage implements BigMessage {
	...
	/**
	 * Creates basic multiplication table search response network message.
	 */
	public BasicMultiplicationTableSearchResponse() {
