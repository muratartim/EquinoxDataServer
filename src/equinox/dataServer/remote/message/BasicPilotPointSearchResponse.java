...
/**
 * Class for basic pilot point search response network message.
 *
 * @author Murat Artim
 * @date 24 Jan 2018
 * @time 15:05:16
 */
public class BasicPilotPointSearchResponse extends DataMessage implements BigMessage {
	...
	/**
	 * Creates basic pilot point search response network message.
	 */
	public BasicPilotPointSearchResponse() {
