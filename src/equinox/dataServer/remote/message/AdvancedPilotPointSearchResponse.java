...
/**
 * Class for advanced pilot point search response network message.
 *
 * @author Murat Artim
 * @date 24 Jan 2018
 * @time 10:07:54
 */
public class AdvancedPilotPointSearchResponse extends DataMessage implements BigMessage {
	...
	/**
	 * Creates advanced pilot point search response network message.
	 */
	public AdvancedPilotPointSearchResponse() {
