...
/**
 * Class for basic spectrum search response network message.
 *
 * @author Murat Artim
 * @date 24 Jan 2018
 * @time 15:21:24
 */
public class BasicSpectrumSearchResponse extends DataMessage implements BigMessage {
	...
	/**
	 * Creates basic spectrum search response network message.
	 */
	public BasicSpectrumSearchResponse() {
