...
/**
 * Class for basic pilot point search request network message.
 *
 * @author Murat Artim
 * @date 24 Jan 2018
 * @time 15:03:49
 */
public class BasicPilotPointSearchRequest extends DatabaseQueryRequest {
	 ...
	 */
	public BasicPilotPointSearchRequest() {
	}
