...
/**
 * Class for get fatigue missions for spectra response network message.
 * 
 * @author Murat Artim
 * @date 16 Feb 2018
 * @time 10:42:45
 */
public class GetFatigueMissionsForSpectraResponse extends DataMessage {
	 ...
	 */
	public GetFatigueMissionsForSpectraResponse() {
	}
