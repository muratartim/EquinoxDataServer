...
/**
 * Class for Preffas material.
 *
 * @author Murat Artim
 * @date Dec 7, 2015
 * @time 12:45:58 PM
 */
public class PreffasMaterial extends Material {
	...
	/**
	 * Creates Preffas material.
	 *
	 * @param id
	 *            Material ID.
	 */
	public PreffasMaterial(long id) {
		super(id);
	}
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(55, 71).append(id_).toHashCode();
	}

	@Override
	public boolean equals(Object o) {
		if (!(o instanceof PreffasMaterial))
			return false;
		if (o == this)
			return true;
		PreffasMaterial item = (PreffasMaterial) o;
